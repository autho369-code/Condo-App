...
**Business model:** Door-based subscription, everything included, no hidden modules or implementation fees, no long-term contracts. Foundation $157/mo (≤200 units) · Growth $382/mo (≤600) · Portfolio $642/mo (≤1,000) · Enterprise custom (1,000+). Unlimited owners, board members, and vendors on every plan. Trial → paid via in-product billing.
...
| "Migration pain" | White-glove setup on every tier: CSV importers for owners/units/balances, operating-documents checklist, invitation chain, operating manuals delivered to every client. |
