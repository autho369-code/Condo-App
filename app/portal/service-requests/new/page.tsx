          ...
          <CardBody>
            <form action={submitServiceRequest as any} className="space-y-6">
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-ink-500">The more specific you are, the faster we can dispatch the right person.</p>
              </div>
              ...
              <div>
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  {PRIORITY_OPTIONS.map((p) => (
                    <label key={p.value}
                      className="flex cursor-pointer items-start gap-3 rounded-md border border-ink-100 bg-white px-3 py-2 hover:border-brand-500 has-[:checked]:border-brand-500 has-[:checked]:bg-brand-50">
                      <input
                        type="radio"
                        name="priority"
                        value={p.value}
                      ...
                      <div>
                        ...
                        <div className="text-xs text-ink-500">{p.hint}</div>
                      </div>
                    </label>
                  ))}
                </div>
