  ...
  return (
    <div className="h-full overflow-y-auto bg-gray-50 px-8 py-6">
      <div className="mb-6 flex items-start justify-between gap-6">
        <div>
          <div className="text-xs font-semibold uppercase tracking-wider text-gray-500">Automation Center</div>
              ...
              <tbody>
                {reminderRows.map((reminder: any) => (
                  <TR key={reminder.id}>
                    ...
                    <TD className="max-w-xs text-sm text-gray-600">{String(reminder.action).replaceAll(',', ', ')}</TD>
