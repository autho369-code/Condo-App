      ...
      <form action={createAssociation as any} className="mt-6 space-y-5">
        ...
        <Section title="Association Name and Address" padded>
          ...
          <FormRow label="Address" required>
            <input type="text" name="address" required placeholder="Address 1" className="mb-2 w-full max-w-lg rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
            <input type="text" name="address_line_2" placeholder="Address 2" className="w-full max-w-lg rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
          </FormRow>
          <FormRow label="">
            <div className="grid max-w-lg grid-cols-[1fr_120px_140px] gap-2">
              <input type="text" name="city" placeholder="City" className="rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
              <select name="state" className="rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500">
                <option value="">State</option>
                {US_STATES.map((s) => <option key={s} value={s}>{s}</option>)}
              </select>
              <input type="text" name="zip" placeholder="Zip" className="rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
            </div>
          </FormRow>
          <FormRow label="County">
            <input type="text" name="county" className="w-full max-w-md rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
          </FormRow>
        </Section>
        ...
        <Section title="Association Information" padded>
          ...
          <FormRow label="Site Manager">
            <div className="mb-2 grid max-w-md grid-cols-2 gap-2">
              <input type="text" name="site_manager_first_name" placeholder="First Name" className="rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
              <input type="text" name="site_manager_last_name" placeholder="Last Name" className="rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
            </div>
            <input type="tel" name="site_manager_phone" placeholder="Phone Number" className="w-full max-w-xs rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
          </FormRow>
          <FormRow label="Year Built">
            <input type="number" name="year_built" min="1800" max={new Date().getFullYear() + 1} className="w-32 rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
          </FormRow>
          <FormRow label="Management Start Date">
            <input type="date" name="management_start_date" className="w-44 rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
          </FormRow>
        </Section>
        ...
        <Section title="Maintenance Information" padded>
          ...
          <FormRow label="Insurance Expiration">
            <input type="date" name="insurance_expiration" className="w-44 rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
          </FormRow>
          <FormRow label="Maintenance Notes">
            <textarea name="maintenance_notes" rows={3} className="w-full max-w-lg resize-y rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
          </FormRow>
        </Section>

        <Section title="Bank Accounts" padded>
          <FormRow label="Operating Bank Account">
            <select name="operating_bank_account_id" className="w-full max-w-md rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500">
              <option value="">— Select —</option>
  ...
  return (
    <div className="mb-3 grid grid-cols-[200px_1fr] items-start gap-x-3 gap-y-1">
      <label className="pt-1.5 text-sm text-ink-600">
        {label}{label && required && <span className="ml-0.5 text-bordeaux-600">*</span>}
      </label>
      <div>{children}</div>
    </div>
  );
  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      <input
        ...
        className="w-40 rounded border border-ink-200 px-3 py-1.5 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
      />
    </div>
  );
}
