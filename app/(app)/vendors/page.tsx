...
export default async function VendorsPage({
  ...
  return (
    <DataWorkspace
      ...
      actions={
        <>
          <Link href="/vendors/forms" className="inline-flex h-10 items-center rounded-md border border-ink-200 bg-white px-4 text-sm font-medium text-ink-900 hover:bg-cream-50">
            Send vendor form
          </Link>
