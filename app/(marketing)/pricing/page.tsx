...
const plans = [
  {
    ...
    cta: 'See the Platform', href: '/demo',
  ...
  },
  {
    ...
    cta: 'Book a Platform Tour', href: '/demo', featured: true,
  ...
  },
  {
    ...
    cta: 'Request a Portfolio Review', href: '/demo',
  ...
  },
  {
    ...
    cta: 'Talk to Our Team', href: '/demo',
      ...
      <section className="border-t border-gray-100 bg-white py-16">
        <div className="mx-auto max-w-[1280px] px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link href="/demo" className="inline-flex items-center gap-2 rounded-xl bg-[#1E3A5F] px-8 py-4 text-base font-semibold text-white shadow-lg shadow-[#1E3A5F]/20 hover:bg-[#152940] transition">Book a Platform Tour</Link>
