...
export default function SettingsHelpPage() {
  return (
    <div className="mx-auto max-w-3xl space-y-8 px-8 py-6">
      <header>
        <nav className="text-xs font-semibold uppercase tracking-wider text-gray-400">
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-950">Company profile</h2>
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-950">NSF fee</h2>
        <p className="mt-1 text-sm text-gray-600">
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-950">Payment reminders</h2>
        <p className="mt-1 text-sm text-gray-600">
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-950">Fiscal year &amp; statements</h2>
        <p className="mt-1 text-sm text-gray-600">
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-950">Online payment fees</h2>
        <p className="mt-1 text-sm text-gray-600">
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-950">Managing your team</h2>
        <p className="mt-1 text-sm text-gray-600">
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-950">Late fees</h2>
        <p className="mt-1 text-sm text-gray-600">
