...
-- 20260623 fix_v_manager_workload_drop_auth_users had already removed it; keep
-- last_login as NULL to preserve the view's column shape (no app code reads it).
