...
-- "Exposed Auth Users" advisor: v_manager_workload joined auth.users only to read
-- last_sign_in_at. profiles.last_login_at already has that, so drop the auth.users
-- join entirely. Applied to remote DB 2026-06-22.
