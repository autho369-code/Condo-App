...
- **Check lifecycle still open:** paid-check void/stop-payment/reissue controls, immutable check-run grouping/history, visual stock alignment, signature controls, and PDF/print artifact evidence remain required before check printing is certified.
