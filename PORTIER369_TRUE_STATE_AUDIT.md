...
- **Check lifecycle still open:** run-scoped historical reprint rendering, visual stock alignment, signature authorization controls, and PDF/print artifact evidence remain required before check printing is certified.
