...
- **Check lifecycle still open:** visual stock alignment and browser-rendered PDF/print artifact evidence remain required before check printing is certified. An actual electronic-signature image is intentionally not auto-applied by this control.
