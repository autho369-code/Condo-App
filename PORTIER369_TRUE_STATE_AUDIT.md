...
| A/P, bills, vendors, and checks | PARTIAL | A hardened staging check run now proves tenant scope, atomicity, sequencing, one successful write, and replay rejection. Full invoice/approval/ledger/void/reprint lifecycle and printed stock accuracy are not certified. The bills page explicitly advertises unfinished recurring bills, loans, and online payables. |
