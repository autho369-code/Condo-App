...
- **Check lifecycle still open:** visual stock alignment, signature authorization controls, and browser-rendered PDF/print artifact evidence remain required before check printing is certified.
