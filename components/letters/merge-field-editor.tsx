...
export const MERGE_FIELDS: MergeField[] = [
  { key: 'association_name', label: 'Association Name', category: 'Association', preview: 'Selected association' },
  { key: 'association_address', label: 'Association Address', category: 'Association', preview: 'Property record' },
  { key: 'association_city', label: 'Association City', category: 'Association', preview: 'Property record' },
  { key: 'association_state', label: 'Association State', category: 'Association', preview: 'Property record' },
  { key: 'association_zip', label: 'Association Zip', category: 'Association', preview: 'Property record' },
  { key: 'association_phone', label: 'Association Phone', category: 'Association', preview: 'Property record' },
  { key: 'owner_name', label: 'Owner Name', category: 'Owner', preview: 'Selected owner' },
  { key: 'owner_address', label: 'Owner Address', category: 'Owner', preview: 'Owner record' },
  { key: 'owner_email', label: 'Owner Email', category: 'Owner', preview: 'Owner record' },
  { key: 'owner_phone', label: 'Owner Phone', category: 'Owner', preview: 'Owner record' },
  { key: 'owner_unit', label: 'Owner Unit', category: 'Owner', preview: 'Primary active unit' },
  { key: 'owner_account_number', label: 'Owner Account #', category: 'Owner', preview: 'Owner ledger' },
  { key: 'owner_balance', label: 'Owner Balance', category: 'Owner', preview: 'Owner ledger' },
  { key: 'vendor_name', label: 'Vendor Name', category: 'Vendor', preview: 'Selected vendor' },
  { key: 'vendor_address', label: 'Vendor Address', category: 'Vendor', preview: 'Vendor record' },
  { key: 'vendor_email', label: 'Vendor Email', category: 'Vendor', preview: 'Vendor record' },
  { key: 'vendor_phone', label: 'Vendor Phone', category: 'Vendor', preview: 'Vendor record' },
  { key: 'current_date', label: 'Current Date', category: 'Date', preview: 'Generated at preview time' },
  { key: 'current_date_short', label: 'Current Date (Short)', category: 'Date', preview: 'Generated at preview time' },
  { key: 'due_date', label: 'Due Date', category: 'Date', preview: 'Related record' },
  { key: 'amount_due', label: 'Amount Due', category: 'Accounting', preview: 'Related ledger record' },
  { key: 'payment_instructions', label: 'Payment Instructions', category: 'Accounting', preview: 'Association settings' },
  { key: 'board_president_name', label: 'Board President', category: 'Association', preview: 'Active board roster' },
  { key: 'manager_name', label: 'Property Manager', category: 'Association', preview: 'Assigned manager' },
  { key: 'late_fee_amount', label: 'Late Fee Amount', category: 'Accounting', preview: 'Association policy' },
  { key: 'violation_description', label: 'Violation Description', category: 'Violations', preview: 'Related violation' },
  { key: 'violation_rule', label: 'Violation Rule Reference', category: 'Violations', preview: 'Related violation' },
  { key: 'hearing_date', label: 'Hearing Date', category: 'Violations', preview: 'Related violation' },
];
