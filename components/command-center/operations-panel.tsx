...
function getPanelForRoute(pathname: string): PanelSection[] {
  if (pathname === '/dashboard' || pathname === '/') {
    return [
      { title: 'Tasks', links: [
        { label: 'Review violations', href: '/violations' }, { label: 'Approve bills', href: '/bills' },
        { label: 'Assign work orders', href: '/work-orders' }, { label: 'Send notices', href: '/letters/new' },
      ]},
      { title: 'Deadlines', links: [
        { label: 'Upcoming hearings', href: '/violations' }, { label: 'Expiring certificates', href: '/insurance' },
        { label: 'Board meetings', href: '/meetings' },
      ]},
      { title: 'Quick Actions', links: [
        { label: 'New violation', href: '/violations/new' }, { label: 'New work order', href: '/work-orders/new' },
        { label: 'New bill', href: '/bills/new' }, { label: 'New notice', href: '/letters/new' },
      ]},
    ];
  }
  ...
  if (pathname.startsWith('/work-orders')) {
    return [
      { title: 'Tasks', links: [
        { label: 'New work order', href: '/work-orders/new' }, { label: 'Recurring work orders', href: '/recurring-work-orders' },
      ...
      { title: 'Related', links: [
        { label: 'Vendors', href: '/vendors' }, { label: 'Inspections', href: '/inspections' }, { label: 'Unit turns', href: '/unit-turns' },
      ]},
    ];
  }
  ...
  if (pathname.startsWith('/violations')) {
    return [
      { title: 'Tasks', links: [
        { label: 'New violation', href: '/violations/new' }, { label: 'Report violation', href: '/report-violation' },
        { label: 'Schedule hearing', href: '/violations/new' },
      ]},
      { title: 'Reports', links: [{ label: 'Report catalog', href: '/reports' }]},
  ...
  if (pathname.startsWith('/owners')) {
    return [
      { title: 'Tasks', links: [
        { label: 'New owner', href: '/owners/new' }, { label: 'Send notice', href: '/letters/new' },
  ...
  if (pathname.startsWith('/vendors')) {
    return [
      { title: 'Tasks', links: [
        { label: 'New vendor', href: '/vendors/new' }, { label: 'Request documents', href: '/vendors' },
  ...
  if (pathname.startsWith('/bills') || pathname.startsWith('/charges') || pathname.startsWith('/bank-accounts') || pathname.startsWith('/journal-entries') || pathname.startsWith('/gl-accounts') || pathname.startsWith('/bank-transfers') || pathname.startsWith('/budget') || pathname.startsWith('/accounting')) {
    return [
      { title: 'Tasks', links: [
        { label: 'Enter bill', href: '/bills/new' }, { label: 'Bank deposit', href: '/bank-accounts/deposits/new' },
      ]},
      { title: 'Reports', links: [{ label: 'Report catalog', href: '/reports' }]},
      { title: 'Quick Links', links: [
        { label: 'Bank accounts', href: '/bank-accounts' }, { label: 'GL accounts', href: '/gl-accounts' },
        { label: 'Journal entries', href: '/journal-entries' }, { label: '1099 reporting', href: '/accounting/1099' },
      ]},
    ];
  }
  ...
  if (pathname.startsWith('/associations') || pathname.startsWith('/units') || pathname.startsWith('/buildings')) {
    return [
      { title: 'Tasks', links: [
        { label: 'New association', href: '/associations/new' }, { label: 'New unit', href: '/units/new' },
      ]},
      { title: 'Reports', links: [{ label: 'Report catalog', href: '/reports' }]},
    ];
  }
  ...
  if (pathname.startsWith('/reports') || pathname.startsWith('/metrics') || pathname.startsWith('/surveys')) {
    return [
      ...
      { title: 'Common Reports', links: [
        { label: 'Balance sheet', href: '/reports' }, { label: 'Income statement', href: '/reports' },
        { label: 'Delinquency', href: '/reports' }, { label: 'Dues roll', href: '/reports' },
      ]},
    ];
  }
  ...
  if (pathname.startsWith('/documents') || pathname.startsWith('/letters')) {
    return [
      { title: 'Tasks', links: [
        { label: 'New letter', href: '/letters/new' }, { label: 'New template', href: '/documents/templates/new' },
      ]},
      { title: 'Templates', links: [
        { label: 'Documents', href: '/documents' },
      ]},
  ...
  if (pathname.startsWith('/settings')) {
    return [
      { title: 'Settings', links: [
        { label: 'Team management', href: '/settings' }, { label: 'Branding', href: '/settings/branding' },
