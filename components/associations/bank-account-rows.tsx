        ...
        <div key={i} className="grid grid-cols-12 items-end gap-3">
          ...
          <div className="col-span-6">
            ...
            <input
              ...
              className="h-10 w-full rounded border border-ink-200 bg-white px-3 text-sm placeholder:text-ink-400"
            />
            <p className="mt-0.5 text-xs text-ink-500 text-center">(Operating and Escrow Account)</p>
          </div>
          <div className="col-span-1">
            {rows.length > 1 && (
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-200 text-ink-500 hover:bg-gray-300"
                aria-label="Remove"
              >
                ×
              </button>
